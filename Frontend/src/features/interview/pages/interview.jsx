...
const RoadMapDay = ({ day }) => (
    <div className='roadmap-day'>
        <div className='roadmap-day__header'>
            <span className='roadmap-day__badge'>Level {day.day}</span>
...
const Interview = () => {
    ...
    return (
        <div className='interview-page1' style={{ position: 'relative', minHeight: '100vh', backgroundColor: 'transparent' }}>
            {/* ── Fixed & Positioned Animated Background Layer ── */}
            <div 
                className="bg-animation-layer" 
                style={{
                    position: 'fixed',
                    top: 0,
                    left: 0,
                    ...
                    height: '100vh',
                    zIndex: -1,
                    pointerEvents: 'none' // Ensures background doesn't block button clicks
                }}
            >
                <AnimatedBackground />
            </div>
            ...
            <div className='align1' style={{ backgroundColor: 'transparent' }}>
                <div className='interview-page' style={{ backgroundColor: 'transparent' }}>
